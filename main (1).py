...
def Ref():
    ...
    costofburger = cob*35
    costoffilet = cofi*50
    costofpasta = cochee*30
    costofdrinks = codr*15

    costofmeal = "Rs.",str('%.2f'% (costoffries +  costoflargefries + costofburger + costoffilet + costofpasta + costofdrinks))
    PayTax=((costoffries +  costoflargefries + costofburger + costoffilet +  costofpasta + costofdrinks)*0.02)
    Totalcost=(costoffries +  costoflargefries + costofburger + costoffilet  + costofpasta + costofdrinks)
    Ser_Charge=((costoffries +  costoflargefries + costofburger + costoffilet + costofpasta + costofdrinks)/99)
    Service="Rs.",str('%.2f'% Ser_Charge)
    OverAllCost="Rs.",(math.floor( PayTax + Totalcost + Ser_Charge))
...
lblPasta = Label(f1, font=( 'aria' ,16, 'bold' ),text="Pasta",fg="steel blue",bd=10,anchor='w')
lblPasta.grid(row=5,column=0)
txtPasta = Entry(f1,font=('ariel' ,16,'bold'), textvariable=Pasta , bd=6,insertwidth=4,bg="powder blue" ,justify='right')
